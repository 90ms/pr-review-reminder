...
| Homebrew 배포 | 공개 tap, 0.4.0 source Formula, launcher, install/test/strict audit CI | tap CI + main CI |
| 최신 릴리스 | 0.4.0 ad-hoc ZIP/checksum과 Homebrew source 설치 | Release workflow + tap CI |
