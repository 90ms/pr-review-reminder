...
public struct L10n: Sendable {
    ...
    static let en: [String: String] = [
        ...
        "add_skill_files": "Add skill files…",
        "skill_files_empty": "No child skill prompt files selected.",
        "clear": "Clear",
    ...
    static let ko: [String: String] = [
        ...
        "load_file": "파일에서 불러오기…",
        "add_skill_files": "스킬 파일 추가…",
        "skill_files_empty": "선택한 자식 스킬 프롬프트 파일이 없습니다.",
        "clear": "지우기",
        "sec_deps": "의존성",
        "recheck": "다시 확인",
        "gh_installed": "gh 설치됨",
